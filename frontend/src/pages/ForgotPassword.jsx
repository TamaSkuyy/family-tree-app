...
import { z } from "zod";
import {
  TreePine, Mail, ArrowLeft, Send, Loader2, AlertCircle, MailCheck, ShieldCheck, RefreshCw,
      ...
      <div className="min-h-screen flex">
        ...
        >
          <div className="w-full max-w-[420px]">
            ...
            <Link to="/login" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 mb-6 transition-colors" style={anim(0.1)}>
            ...
            <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6 space-x-4" style={anim(0.45)}>
    ...
    <div className="min-h-screen flex">
      ...
      >
        <div className="w-full max-w-[420px] text-center">
          ...
          {/* Info box */}
          <div className="mt-6 p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-left" style={anim(0.3)}>
          ...
          {/* Actions */}
          <div className="space-y-3 mt-6" style={anim(0.4)}>
          ...
          {/* Help section */}
          <div className="mt-8 border-t border-slate-200 dark:border-slate-700 pt-4" style={anim(0.6)}>
            <button
          ...
          <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6" style={anim(0.7)}>
